<?php
/**
 * Standalone install + heartbeat reporter for Panth_EuWithdrawal.
 *
 ...
 *
 *   - reportInstall(): fires from Setup/RecurringData on setup:upgrade.
 *     Deduped via Magento\Framework\FlagManager so re-running setup:upgrade on
 *     the same module version is a no-op.
 *   - reportHeartbeat(): daily, fires from Cron/SendHeartbeat, deduped per day.
 *
 * Failures are swallowed and logged; they MUST NOT block setup:upgrade or cron.
 */
declare(strict_types=1);

namespace Panth\EuWithdrawal\Service;
...
{
    public const MAGENTO_MODULE = 'Panth_EuWithdrawal';
    public const COMPOSER_PACKAGE = 'mage2kishan/module-eu-withdrawal';
